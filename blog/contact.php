...
if(isset($_POST['email'])){
  ...
  $email_to = "joeyzmarion@gmail.com";
  $email_subject = "This is from your website contact form"
  $email_from = "Making it with the Marions"
  ...
  // validation
    ...
    $error_message = "";
    $email_exp = '/^[A_Za-z0-9._%-]+@[A-Za-z0-9.-]+\.[A-Za-z]
    {2,4}$/';
...
Thank you for contacting us. We will be in touch with you shortly if requested. <br/>
